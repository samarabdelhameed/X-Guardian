      ...
      {isOpen && (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className="bg-[#0a0a0a] border border-white/10 rounded-[3rem] w-full max-w-lg shadow-[0_0_100px_rgba(0,0,0,1)] relative overflow-hidden p-10"
          >
            ...
            <div className="space-y-8">
               ...
               <div className="grid grid-cols-2 gap-4">
                 <button className="py-4 rounded-2xl bg-white/5 border border-white/5 font-black text-xs uppercase tracking-widest hover:bg-white/10 transition-all">
                   Decline
                 </button>
                 <button className="py-4 rounded-2xl bg-yellow-400 text-black font-black text-xs uppercase tracking-widest hover:bg-yellow-500 transition-all shadow-[0_0_20px_rgba(251,191,36,0.3)]">
                   Confirm Swap
                 </button>
               </div>

               <div className="text-center">
                 <span className="text-[10px] text-gray-600 font-bold uppercase tracking-[0.2em] block mb-4">Transaction History</span>
                 <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-2xl">
                   <div className="text-emerald-500 text-[10px] font-black uppercase mb-1">Protection Active - Order Verified</div>
                   <p className="text-[9px] text-emerald-400/60 font-mono break-all line-clamp-1">
